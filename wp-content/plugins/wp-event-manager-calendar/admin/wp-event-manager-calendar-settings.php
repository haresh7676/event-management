		...
		$settings[ 'event_calendar' ] =  array(
                        ...
                        array(
                            ...
                            array(
                                ...
                                'std' 		=> '',
                                'label' 	=> __( 'Calendar Page ID', 'wp-event-manager-calendar' ),
                                'desc'		=> __( 'So that the plugin knows where to link event calendar, you must select the page where you have placed the [events_calendar] shortcode.', 'wp-event-manager-calendar' ),
                                'type'      => 'page'
                            )	
