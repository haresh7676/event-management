						                                        ...
						                                        array(
																	...
																	array(
																	   ...
																	   array(
							                                              ...
							                                              'std'        => '',
							                                              'label'      => __( 'Google address autocomplete (admin)', 'wp-event-manager-google-maps' ),		
																	    ...
																	    array(
							                                              ...
							                                              'std'        => '',
							                                              'label'      => __( 'Google address autocomplete (front-end) - new/edit event form', 'wp-event-manager-google-maps' ),		
							                                              'cb_label'    => __( 'Yes', 'wp-event-manager-google-maps' ),
