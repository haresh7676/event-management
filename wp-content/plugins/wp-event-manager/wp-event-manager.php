...
class WP_Event_Manager {
	...
	public function __construct() 
	{
		...
		define( 'EVENT_MANAGER_VERSION', '3.1.5' );
	...
	public function frontend_scripts() 
	{
		...
		if ( apply_filters( 'event_manager_chosen_enabled', $chosen_used_on_page ) || is_page('my-account') ) {
		...
		if ( apply_filters( 'event_manager_ajax_file_upload_enabled', true ) ) {
			...
			wp_register_script( 'wp-event-manager-ajax-file-upload', EVENT_MANAGER_PLUGIN_URL . '/assets/js/ajax-file-upload.js', array( 'jquery', 'jquery-fileupload' ), EVENT_MANAGER_VERSION, true );
		...
		wp_register_script( 'wp-event-manager-event-submission', EVENT_MANAGER_PLUGIN_URL . '/assets/js/event-submission.js', array('jquery','jquery-ui-core','jquery-ui-datepicker') , EVENT_MANAGER_VERSION, true );
