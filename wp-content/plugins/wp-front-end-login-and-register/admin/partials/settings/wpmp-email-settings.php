...
<tr valign="top">
    ...
    <td>
        ...
        <input type="text" name="wpmp_new_account_verification_email_subject" value='<?php echo (!empty($wpmp_settings['wpmp_new_account_verification_email_subject'])) ? $wpmp_settings['wpmp_new_account_verification_email_subject'] : ''; ?>' class='wide' />
...
<tr valign="top">
    ...
    <td>
        ...
        <textarea name="wpmp_new_account_verification_email_message" class='wide' style="width:100%; height:250px;"><?php echo (!empty($wpmp_settings['wpmp_new_account_verification_email_message'])) ? $wpmp_settings['wpmp_new_account_verification_email_message'] : ''; ?></textarea>
...
<tr valign="top">
    ...
    <td>
        ...
        <input type="text" name="wpmp_password_reset_email_subject" value='<?php echo (!empty($wpmp_settings['wpmp_password_reset_email_subject'])) ? $wpmp_settings['wpmp_password_reset_email_subject'] : ''; ?>' class='wide' />
